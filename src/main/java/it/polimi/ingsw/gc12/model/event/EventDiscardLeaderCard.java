...
public class EventDiscardLeaderCard extends Event{

	private int cardId;

	public EventDiscardLeaderCard(Player player, int cardId) {
		super(player);
		this.cardId = cardId;
	}
	...
	public void executeClientSide(ClientHandler client) {
		...
		client.getMatch().discardLeaderCard(player.getColor(), cardId);
	}
